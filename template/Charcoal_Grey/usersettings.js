...
(function() {
  ...
  model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "rgba(255, 147, 0, 0.75)");
	...
	model.publish(rh.consts('KEY_CUSTOM_BUTTONS_CONFIG'), [{"name":"ReportaBug","id":"3","key":"36494","title":"Report a Problem","href":"https://github.com/YoYoGames/GameMaker-Bugs/issues/new?assignees=&labels=docs-bug&projects=&template=docs_bug_report.yml","image":"bug-report-final.png"},{"image":"expand_all.svg","name":"Expand/Collapse All","onclick":"rh.model.publish(rh.consts('EVT_EXPAND_COLLAPSE_ALL'));return false;","title":"Expand/Collapse All","id":"0","key":"06495"},{"image":"removesearch_mark.svg","name":"RemoveHighlight","onclick":"rh.model.publish(rh.consts('EVT_REMOVE_HIGHLIGHT'));return false;","title":"Remove Highlight","id":"1","key":"16496"},{"image":"print_desktop.png","name":"Print","onclick":"rh.model.publish(rh.consts('EVT_PRINT_TOPIC'));return false;","title":"Print","id":"2","key":"26497"}])
